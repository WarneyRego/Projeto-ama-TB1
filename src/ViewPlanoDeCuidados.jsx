            ...
            <div className="card-body">
              <form className="form">
                <div className="form-group">
                  <label>Nome:</label>
                  <input className="form-control" type="text" value={editData.nome} onChange={(e) => setEditData({ ...editData, nome: e.target.value })} />
                </div>
                <div className="form-group">
                  <label>Atividades:</label>
                  <input className="form-control" type="text" value={editData.atividades} onChange={(e) => setEditData({ ...editData, atividades: e.target.value })} />
                </div>
                <div className="form-group">
                  <label>Nomes da Medicação:</label>
                  <input className="form-control" type="text" value={editData.nomesDaMedicação} onChange={(e) => setEditData({ ...editData, nomesDaMedicação: e.target.value })} />
                </div>
                <div className="form-group">
                  <label>Dosagem:</label>
                  <input className="form-control" type="text" value={editData.dosagem} onChange={(e) => setEditData({ ...editData, dosagem: e.target.value })} />
                </div>
                <div className="form-group">
                  <label>Frequência:</label>
                  <input className="form-control" type="text" value={editData.frequência} onChange={(e) => setEditData({ ...editData, frequência: e.target.value })} />
                </div>
                <div className="form-group">
                  <label>Orientações:</label>
                  <input className="form-control" type="text" value={editData.orientações} onChange={(e) => setEditData({ ...editData, orientações: e.target.value })} />
                </div>
                <div className="form-group">
                  <label>Observação Administrativa:</label>
                  <input className="form-control" type="text" value={editData.observaçãoAdministrativa} onChange={(e) => setEditData({ ...editData, observaçãoAdministrativa: e.target.value })} />
                </div>
